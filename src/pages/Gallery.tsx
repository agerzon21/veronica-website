...
export const sampleImages = {
  portraits: [
    ...
    {
      id: 'handmade-swimsuit-seashell-portrait',
    ...
    {
      id: 'bw-beach-portrait-woman-sand',
    ...
    {
      id: 'horse-riding-scenic-shoreline',
    ...
    {
      id: 'girl-blue-dress-lotuses-almaty',
    ...
    {
      id: 'sunset-silhouette-blonde-girl-almaty',
    ...
    {
      id: 'eye-portrait-book-background',
    ...
    {
      id: 'modern-creation-homage-michelangelo',
    ...
    {
      id: 'elegant-girl-golden-lion-statue',
    ...
    {
      id: 'stylish-whiskey-toast-kitchen',
    ...
    {
      id: 'monica-bellucci-lookalike-portrait',
    ...
    {
      id: 'stylish-breakfast-scene-almaty',
    ...
    {
      id: 'girl-embracing-greek-statue-almaty',
    ...
    {
      id: 'cozy-tea-reading-moment-almaty',
    ...
    {
      id: 'beach-horse-ride-mountain-view',
    ...
    {
      id: 'summer-fun-girls-riding-horse-sea',
    ...
    {
      id: 'aerial-view-red-bikini-palm-leaf',
    ...
    {
      id: 'pink-bikini-beach-relaxation',
    ...
    {
      id: 'girl-holding-lotus-lotus-field',
    ...
    {
      id: 'studio-portrait-white-dress-pearls',
    ...
    {
      id: 'vintage-style-saber-cyclorama',
    ...
    {
      id: 'yellow-tank-top-sunflower-field',
    ...
    {
      id: 'lace-pink-dress-blue-glacier',
    ...
    {
      id: 'pink-lace-dress-blue-glacier-contrast',
    ...
    {
      id: 'elegant-black-woman-red-flower',
    ...
    {
      id: 'summer-swimsuit-beauty-beach',
    ...
    {
      id: 'tropical-bikini-pose-bamboo',
    ...
    {
      id: 'swimsuit-girl-palm-leaf-ocean',
  ...
  weddings: [
    ...
    {
      id: 'elegant-interior-wedding-portrait',
    ...
    {
      id: 'warm-toned-bride-groom-portrait',
    ...
    {
      id: 'bw-sofa-portrait-bride-groom',
    ...
    {
      id: 'wedding-champagne-celebration',
    ...
    {
      id: 'groom-getting-ready-collage-bw',
    ...
    {
      id: 'park-embrace-portrait-newlyweds',
    ...
    {
      id: 'newlyweds-window-reflection',
    ...
    {
      id: 'lotus-pond-reflection-newlyweds',
    ...
    {
      id: 'vintage-book-rings-still-life',
    ...
    {
      id: 'grooms-wedding-prep-collage',
    ...
    {
      id: 'groom-botanical-garden-blurred-bride',
    ...
    {
      id: 'winged-couple-fantasy-portrait',
    ...
    {
      id: 'elegant-bride-portrait-light-play',
    ...
    {
      id: 'magical-drone-show-celebration',
  ...
  family: [
    ...
    {
      id: 'mother-daughter-forest-smiles',
    ...
    {
      id: 'mother-daughter-pink-background',
    ...
    {
      id: 'christmas-morning-gift-opening',
    ...
    {
      id: 'joyful-family-studio-portrait',
    ...
    {
      id: 'daughters-kissing-mom-autumn',
    ...
    {
      id: 'large-family-beach-gathering',
    ...
    {
      id: 'elegant-family-studio-portrait-black',
  ...
  maternity: [
    {
      id: 'husband-kissing-pregnant-wife',
    ...
    {
      id: 'pregnant-friends-colorful-dresses',
    ...
    {
      id: 'beach-maternity-togetherness',
    ...
    {
      id: 'couples-beach-baby-bump-moment',
    ...
    {
      id: 'elegant-studio-maternity-pose',
    ...
    {
      id: 'bw-maternity-portrait-husband',
