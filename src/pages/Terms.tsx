    ...
    <>
      ...
      >
        ...
        <PolicySection title="3. Model release + image takedown requests" id="takedown">
          ...
          <P>
            Send an email to{' '}
            <Text as="a" href="mailto:vero@vero.photography" color="#c9a96e" _hover={{ textDecoration: 'underline' }}>
        ...
        <PolicySection title="6. Third-party services + links">
          <P>
            ...
            <Text as="a" href="/privacy" color="#c9a96e" _hover={{ textDecoration: 'underline' }}>
              Privacy Policy
            </Text>
